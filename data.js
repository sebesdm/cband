...
const satellites = [
    {
        ...
        transponders: [
            ...
            { num:3,  freq:3760, pol:'H', name:'C-SPAN / NASA Worldnet', color:'#141428', accent:'#6666aa', textColor:'#ddd', program:'DEUTSCHE WELLE', type:'educational', audio:'6.20', stereo:false, videos:[{id:'TkjtnteqL64',duration:10296}] },
            ...
            { num:7,  freq:3840, pol:'H', name:'Main Street TV', color:'#0a0a0a', accent:'#888', textColor:'#fff', program:'LOCAL PROGRAMMING', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:1000}] },
    ...
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'Arab Network', color:'#0a0a1a', accent:'#44aacc', textColor:'#fff', program:'ARABIC PROGRAMMING', type:'entertainment', audio:'6.80', stereo:false, tagline:'M-Thu 5PM-6AM ET', videos:[{id:'aQpaB9jmNCE',duration:3539}] },
            ...
            { num:6,  freq:3820, pol:'V', name:null },
            { num:7,  freq:3840, pol:'H', name:'American Infochannel', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'INFOMERCIALS', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574}] },
            { num:8,  freq:3860, pol:'V', name:null },
            { num:9,  freq:3880, pol:'H', name:null },
            { num:10, freq:3900, pol:'V', name:null },
            { num:11, freq:3920, pol:'H', name:'Home Shopping Club', color:'#161608', accent:'#cccc44', textColor:'#fff', program:'HOME SHOPPING', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:5000}] },
            ...
            { num:14, freq:3980, pol:'V', name:null },
            { num:15, freq:4000, pol:'H', name:'Showcase America', color:'#0a0a0a', accent:'#888', textColor:'#fff', program:'B-MOVIES', type:'entertainment', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:8000}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:6,  freq:3820, pol:'V', name:null },
            { num:7,  freq:3840, pol:'H', name:'Antenne 2 French', color:'#0a0a28', accent:'#2244cc', textColor:'#fff', program:'JOURNAL T\u00c9L\u00c9VIS\u00c9', type:'entertainment', audio:'6.80', stereo:false, tagline:'France 2', videos:[{id:'NfP7qBPrsFc',duration:129}] },
            { num:8,  freq:3860, pol:'V', name:null },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:10, freq:3900, pol:'V', name:'ABC East Feed', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'WORLD NEWS TONIGHT', type:'network', audio:'6.80', stereo:true, videos:[{id:'w6qH2jBfyVo',duration:1417},{id:'EBuvOLjsF00',duration:1738},{id:'EerSHhjR0g0',duration:1717}] },
            ...
            { num:15, freq:4000, pol:'H', name:'AgSat', color:'#0a1a0a', accent:'#44aa44', textColor:'#fff', program:'AGRICULTURE TODAY', type:'educational', audio:'6.20', stereo:false, tagline:'M-F 10-11AM ET', videos:[{id:'55DP2kimCIY',duration:1588}] },
            { num:16, freq:4020, pol:'V', name:'Starnet', color:'#0a0a0a', accent:'#888', textColor:'#fff', program:'LATE NIGHT MOVIES', type:'entertainment', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:11000}] },
    ...
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'Cable Listings', color:'#0a0a0a', accent:'#44dddd', textColor:'#0ff', program:'CHANNEL GUIDE', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'XOizHA_IvuY',duration:963,start:300}] },
            ...
            { num:4,  freq:3780, pol:'V', name:'Community Bulletin Board', color:'#0a0a0a', accent:'#44aa44', textColor:'#0f0', program:'LOCAL COMMUNITY CALENDAR', type:'entertainment', audio:'6.20', stereo:false, tagline:'Public Access', videos:[{id:'AqobbIAJdOE',duration:210},{id:'Da7_AcM5pzk',duration:181},{id:'XOizHA_IvuY',duration:963}] },
            { num:5,  freq:3800, pol:'H', name:'KTVT Dallas', color:'#141414', accent:'#cc8844', textColor:'#fff', program:'DALLAS', type:'entertainment', audio:'6.80', stereo:true, tagline:'CBS 11 Dallas', videos:[{id:'SWzn1qrrJsM',duration:3692}] },
                                    { num:6,  freq:3820, pol:'V', name:'Community Access', color:'#0a0a0a', accent:'#44aa44', textColor:'#0f0', program:'LOCAL EVENTS', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'XOizHA_IvuY',duration:963},{id:'60aZrE9XItU',duration:90},{id:'u9nOP4hKwJc',duration:177}] },
            { num:7,  freq:3840, pol:'H', name:'Classified Ads', color:'#0a0a0a', accent:'#ccaa44', textColor:'#ff0', program:'BUY SELL TRADE', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'XOizHA_IvuY',duration:460,start:500}] },
            { num:8,  freq:3860, pol:'V', name:'Casino Game Channel', color:'#0a0a0a', accent:'#ccaa44', textColor:'#ff0', program:'VIDEO KENO', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'MgPeIQJAAoM',duration:459}] },
            { num:9,  freq:3880, pol:'H', name:'WPIX New York', color:'#0a0a1a', accent:'#4488cc', textColor:'#fff', program:'THE HONEYMOONERS', type:'entertainment', audio:'6.80', stereo:true, tagline:'WB 11 New York', videos:[{id:'08WE4ca1e-M',duration:1157,maxDur:150}] },
            ...
            { num:15, freq:4000, pol:'H', name:'KTLA Los Angeles', color:'#141414', accent:'#cc8800', textColor:'#fff', program:'MARRIED... WITH CHILDREN', type:'entertainment', audio:'6.80', stereo:true, tagline:'The WB Los Angeles', videos:[{id:'nSIlomMNLa0',duration:864,maxDur:150}] },
            ...
            { num:23, freq:4160, pol:'H', name:'Home Team Sports', color:'#0a1a0a', accent:'#44cc44', textColor:'#fff', program:'WASHINGTON CAPITALS HOCKEY', type:'sports', audio:'6.80', stereo:true, tagline:'Washington DC', videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
            { num:24, freq:4180, pol:'V', name:'RTP Internacional', color:'#0a0a28', accent:'#4466cc', textColor:'#fff', program:'TELES\u00c1O', type:'entertainment', audio:'6.80', stereo:false, tagline:'Portugal', videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
        ]
    },
    {
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:2,  freq:3740, pol:'V', name:'CBS West', scrambled:true, color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'60 MINUTES', type:'network', audio:'6.80', stereo:true, videos:[{id:'SaF__mZECrM',duration:2077}] },
            ...
            { num:6,  freq:3820, pol:'V', name:'Cable Program Guide', color:'#000808', accent:'#44dddd', textColor:'#0ff', program:'CHANNEL LISTINGS', type:'entertainment', audio:'6.20', stereo:false, videos:[{id:'7Hx9HaiCIAk',duration:3092}] },
            ...
            { num:18, freq:4060, pol:'V', name:'CBS News Feeds', color:'#0a0a1a', accent:'#aaa', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBS NEWS \u2014 FIELD REPORT', videos:[{id:'1tfJAJGR_iM',duration:2565,maxDur:150}] },
            { num:19, freq:4080, pol:'H', name:'CBS East', scrambled:true, color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'LATE SHOW WITH DAVID LETTERMAN', type:'network', audio:'6.80', stereo:true, videos:[{id:'SaF__mZECrM',duration:2077,start:500}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:8,  freq:3860, pol:'V', name:null },
            { num:9,  freq:3880, pol:'H', name:'Satellite Market USA', color:'#0a0a0a', accent:'#888', textColor:'#fff', program:'CLASSIFIED ADS', type:'shopping', audio:'6.20', stereo:false, videos:[{id:'XOizHA_IvuY',duration:462,start:0}] },
            { num:10, freq:3900, pol:'V', name:null },
            ...
            { num:13, freq:3960, pol:'H', name:'Video Catalog Channel', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'INFOMERCIALS', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:3000}] },
            ...
            { num:15, freq:4000, pol:'H', name:'Video Catalog Channel', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'INFOMERCIALS', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:7000}] },
            { num:16, freq:4020, pol:'V', name:null },
            { num:17, freq:4040, pol:'H', name:'Shop at Home', color:'#161608', accent:'#cccc44', textColor:'#fff', program:'JEWELRY CLEARANCE', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:2000}] },
            { num:18, freq:4060, pol:'V', name:'ABC West', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'ABC WEST FEED', type:'network', audio:'6.80', stereo:true, videos:[{id:'EBuvOLjsF00',duration:1738,start:500}] },
            { num:19, freq:4080, pol:'H', name:'VIA TV Shopping', color:'#161608', accent:'#cccc44', textColor:'#fff', program:'HOME SHOPPING', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:4000}] },
            ...
            { num:21, freq:4120, pol:'H', name:'American Collectibles', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'COLLECTIBLES AUCTION', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:6000}] },
            { num:22, freq:4140, pol:'V', name:'Future Mart', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'HOME SHOPPING', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:9000}] },
            { num:23, freq:4160, pol:'H', name:'Access America', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'INFOMERCIALS', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:3000}] },
            { num:24, freq:4180, pol:'V', name:'Skyvision', color:'#141414', accent:'#ccaa44', textColor:'#fff', program:'INFOMERCIALS', type:'shopping', audio:'6.80', stereo:false, videos:[{id:'oemoqEuJdFE',duration:14574,start:7000}] },
        ]
    },
    {
        ...
        transponders: [
            ...
            { num:15, freq:4000, pol:'H', name:'CBS Feeds / Skyvision', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBS \u2014 NETWORK FEED', videos:[{id:'kE5_4vBscRs',duration:1738},{id:'LAazz7mIrEE',duration:1697}] },
            { num:16, freq:4020, pol:'V', name:null },
            { num:17, freq:4040, pol:'H', name:null },
            ...
            { num:19, freq:4080, pol:'H', name:'Ag Day / PhoneVoter', color:'#0a1a0a', accent:'#44aa44', textColor:'#fff', program:'AGRICULTURE NEWS', type:'educational', audio:'6.20', stereo:false, tagline:'Farm Broadcasting', videos:[{id:'55DP2kimCIY',duration:1588}] },
            ...
            { num:21, freq:4120, pol:'H', name:'Best Picture Show', color:'#0a0a0a', accent:'#ccaa44', textColor:'#fff', program:'LATE NIGHT MOVIE', type:'entertainment', audio:'6.80', stereo:false, tagline:'Mon 8:30PM, M-Sat 12AM ET', videos:[{id:'oemoqEuJdFE',duration:14574,start:12000}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:7,  freq:3840, pol:'H', name:'CBS Feeds', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBS \u2014 OCCASIONAL VIDEO', videos:[{id:'kE5_4vBscRs',duration:1738},{id:'LAazz7mIrEE',duration:1697}] },
            ...
            { num:16, freq:4020, pol:'V', name:'CBS West', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'CBS WEST FEED', type:'network', audio:'6.80', stereo:true, videos:[{id:'kE5_4vBscRs',duration:1738}] },
            ...
            { num:18, freq:4060, pol:'V', name:'CBS Feeds', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBS \u2014 OCCASIONAL VIDEO', videos:[{id:'kE5_4vBscRs',duration:1738},{id:'LAazz7mIrEE',duration:1697}] },
            ...
            { num:20, freq:4100, pol:'V', name:'CBS East Feed', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'CBS NETWORK', type:'network', audio:'6.80', stereo:true, videos:[{id:'kE5_4vBscRs',duration:1738},{id:'LAazz7mIrEE',duration:1697}] },
            { num:21, freq:4120, pol:'H', name:'CBS Feeds', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'KEYSTONE / CBS', videos:[{id:'kE5_4vBscRs',duration:1738},{id:'LAazz7mIrEE',duration:1697}] },
            { num:22, freq:4140, pol:'V', name:null },
            { num:23, freq:4160, pol:'H', name:null },
            { num:24, freq:4180, pol:'V', name:'CBS News Feeds', color:'#0a0a1a', accent:'#aaa', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBS NEWS \u2014 FEEDS', videos:[{id:'LAazz7mIrEE',duration:1697}] },
        ]
    },
    {
        ...
        transponders: [
            ...
            { num:9,  freq:3880, pol:'H', name:'3ABN', color:'#141428', accent:'#8888cc', textColor:'#fff', program:'THREE ANGELS BROADCASTING', type:'religious', audio:'6.20', stereo:false, videos:[{id:'pbBvEp4xScc',duration:3453}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:3,  freq:3760, pol:'H', name:'CBC Feeds', color:'#240808', accent:'#cc2222', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBC \u2014 OCCASIONAL VIDEO', videos:[{id:'NgPMeDgDJOs',duration:398}] },
            ...
            { num:5,  freq:3800, pol:'H', name:'CBC Feeds', color:'#240808', accent:'#cc2222', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBC \u2014 REMOTE STANDBY', videos:[{id:'cVzNZyLjGWk',duration:337}] },
            ...
            { num:7,  freq:3840, pol:'H', name:'CBC / BBC News', color:'#240808', accent:'#cc4444', textColor:'#fff', program:'BBC WORLD SERVICE', type:'news', audio:'6.80', stereo:false, tagline:'M-F 4:54 & 8:25AM ET', videos:[{id:'cVzNZyLjGWk',duration:337},{id:'P4g3h9U4PoQ',duration:35}] },
            ...
            { num:11, freq:3920, pol:'H', name:'CBC North West', color:'#240808', accent:'#cc2222', textColor:'#fff', program:'HOCKEY NIGHT IN CANADA', type:'network', audio:'6.80', stereo:true, tagline:'Canadian Broadcasting Corporation', videos:[{id:'cVzNZyLjGWk',duration:337},{id:'qvfvnz_cAfU',duration:73}] },
            ...
            { num:17, freq:4040, pol:'H', name:'CBC / VISNews', color:'#180808', accent:'#aa2222', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'CBC \u2014 VISNEWS FEED', videos:[{id:'NgPMeDgDJOs',duration:398}] },
            ...
            { num:19, freq:4080, pol:'H', name:'CBC North East', color:'#240808', accent:'#cc2222', textColor:'#fff', program:'CBC NORTH', type:'network', audio:'6.80', stereo:true, tagline:'Canadian Broadcasting Corporation', videos:[{id:'cVzNZyLjGWk',duration:337}] },
            { num:20, freq:4100, pol:'V', name:null },
        ]
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'Canal 2 Televisa', color:'#1a0a0a', accent:'#cc4444', textColor:'#fff', program:'EL CANAL DE LAS ESTRELLAS', type:'entertainment', audio:'6.80', stereo:true, tagline:'Televisa', videos:[{id:'Vja_srr-ack',duration:3319}] },
            { num:2,  freq:3740, pol:'V', name:'Canal 5 XHGC', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'CARTOONS', type:'kids', audio:'6.80', stereo:true, tagline:'Televisa', videos:[{id:'ytb0w0RqjY0',duration:1927},{id:'Qv6Yie7hLdo',duration:770}] },
            { num:3,  freq:3760, pol:'H', name:null },
            { num:4,  freq:3780, pol:'V', name:'Canal 13 Azteca', color:'#0a1a0a', accent:'#44aa44', textColor:'#fff', program:'NOTICIAS', type:'news', audio:'6.80', stereo:true, videos:[{id:'wkt_gvcp_ZM',duration:987}] },
            { num:5,  freq:3800, pol:'H', name:null },
    ...
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'Televisa Feed', color:'#1a0a0a', accent:'#cc4444', textColor:'#fff', program:'TELEVISA NETWORK', type:'entertainment', audio:'6.80', stereo:true, videos:[{id:'Vja_srr-ack',duration:3319,start:1000}] },
            { num:2,  freq:3740, pol:'V', name:null },
            { num:3,  freq:3760, pol:'H', name:null },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:7,  freq:3840, pol:'H', name:'WGN', color:'#141414', accent:'#aaa', textColor:'#fff', program:'BOZO SUPER SUNDAY', type:'entertainment', audio:'6.80', stereo:true, tagline:'Chicago Superstation', videos:[{id:'QHucRHAHyFk',duration:1154}] },
            ...
            { num:10, freq:3900, pol:'V', name:'MOR Music TV', color:'#0a0a1a', accent:'#6688cc', textColor:'#fff', program:'EASY LISTENING', type:'music', audio:'6.80', stereo:true, videos:[{id:'08WE4ca1e-M',duration:1157,maxDur:150}] },
            ...
            { num:16, freq:4020, pol:'V', name:'Cinemax West', scrambled:true, color:'#081624', accent:'#3498db', textColor:'#fff', program:'DEMOLITION MAN (1993)', type:'premium', audio:'6.80', stereo:true, videos:[{id:'GxyxPWX1LcY',duration:36},{id:'MQgRg53Xk-o',duration:170}] },
            ...
            { num:20, freq:4100, pol:'V', name:'BET', color:'#160816', accent:'#cc44cc', textColor:'#fff', program:'RAP CITY: THE BASEMENT', type:'entertainment', audio:'6.80', stereo:true, tagline:'Black Entertainment Television', videos:[{id:'F6xkQCgkxd0',duration:4631}] },
            ...
            { num:22, freq:4140, pol:'V', name:'CNN Headline News', color:'#280808', accent:'#ee2222', textColor:'#fff', program:'HEADLINE NEWS', type:'news', audio:'6.80', stereo:true, ticker:'NORTHRIDGE EARTHQUAKE KILLS 57 \u2022 NANCY KERRIGAN ATTACK \u2022 BRADY BILL SIGNED INTO LAW \u2022 SPACE SHUTTLE DISCOVERY LAUNCHES', videos:[{id:'aPfpZZsWs70',duration:6776,start:300},{id:'hzUFpF5o0RU',duration:118},{id:'9N_FlLK69o4',duration:200},{id:'ZtBiX4s3yq4',duration:1247}] },
            { num:23, freq:4160, pol:'H', name:'A&E', color:'#141414', accent:'#aaa', textColor:'#fff', program:'BIOGRAPHY: ELVIS PRESLEY', type:'entertainment', audio:'6.80', stereo:true, tagline:'Arts & Entertainment', videos:[{id:'9gqdqtv14mE',duration:2811},{id:'P4w5CwCAq20',duration:707},{id:'frQEgjJRgRg',duration:2644}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:2,  freq:3740, pol:'V', name:'TLC', color:'#160824', accent:'#cc44ff', textColor:'#fff', program:'HOMETIME', type:'educational', audio:'6.80', stereo:true, tagline:'The Learning Channel', videos:[{id:'08WE4ca1e-M',duration:1157,maxDur:150}] },
            ...
            { num:7,  freq:3840, pol:'H', name:'C-SPAN', color:'#141428', accent:'#6666aa', textColor:'#ddd', program:'U.S. HOUSE OF REPRESENTATIVES', type:'educational', audio:'6.20', stereo:false, videos:[{id:'TkjtnteqL64',duration:10296,start:3000}] },
            ...
            { num:22, freq:4140, pol:'V', name:'SportsChannel America', color:'#0a1a0a', accent:'#44cc44', textColor:'#fff', program:'SPORTS TONIGHT', type:'sports', audio:'6.80', stereo:true, videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
    ...
    },
    {
        ...
        transponders: [
            ...
            { num:2,  freq:3740, pol:'V', name:'Action PPV', color:'#0a0a0a', accent:'#cc8844', textColor:'#fff', program:'ORDER NOW — 1-800-885-4000', type:'shopping', audio:'6.80', stereo:true, videos:[{id:'eOP0CmrNT2A',duration:1491},{id:'fdhtsuGBuAI',duration:141}] },
            ...
            { num:4,  freq:3780, pol:'V', name:'TV Food Network', color:'#161608', accent:'#ccaa44', textColor:'#fff', program:'EMERIL LIVE', type:'entertainment', audio:'6.80', stereo:true, tagline:'Food Network', videos:[{id:'08WE4ca1e-M',duration:1157,maxDur:150}] },
            { num:5,  freq:3800, pol:'H', name:'All News Channel', color:'#0a0a1a', accent:'#aaa', textColor:'#fff', program:'NEWS UPDATE', type:'news', audio:'6.80', stereo:false, videos:[{id:'1tfJAJGR_iM',duration:2565,maxDur:150}] },
            ...
            { num:19, freq:4080, pol:'H', name:'Cinemax East', scrambled:true, color:'#081624', accent:'#3498db', textColor:'#fff', program:'DEMOLITION MAN (1993)', type:'premium', audio:'6.80', stereo:true, videos:[{id:'GxyxPWX1LcY',duration:36},{id:'MQgRg53Xk-o',duration:170}] },
            ...
            { num:22, freq:4140, pol:'V', name:'Nostalgia TV', color:'#0a0a0a', accent:'#999', textColor:'#fff', program:'THE ED SULLIVAN SHOW', type:'entertainment', audio:'6.80', stereo:false, videos:[{id:'08WE4ca1e-M',duration:1157,maxDur:150}] },
    ...
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'AMC', color:'#180808', accent:'#cc4444', textColor:'#fff', program:'REAR WINDOW (1954)', type:'entertainment', audio:'6.80', stereo:true, tagline:'American Movie Classics', videos:[{id:'MCxmwieh43Y',duration:967},{id:'j5jn7fu_zos',duration:830},{id:'DmZG5CVbYfs',duration:627}] },
            ...
            { num:7,  freq:3840, pol:'H', name:'Bravo', color:'#0a0a1a', accent:'#cc4444', textColor:'#fff', program:'INSIDE THE ACTORS STUDIO', type:'entertainment', audio:'6.80', stereo:true, videos:[{id:'MCxmwieh43Y',duration:967},{id:'DmZG5CVbYfs',duration:627}] },
            ...
            { num:15, freq:4000, pol:'H', name:'WWOR EMI Service', color:'#141414', accent:'#aaa', textColor:'#fff', program:'LIVE SATELLITE FEED', type:'wild_feed', audio:'6.20', stereo:false, tagline:'WWOR \u2014 SECAUCUS NJ', videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
            ...
            { num:18, freq:4060, pol:'V', name:'Hot Choice PPV', color:'#0a0a0a', accent:'#cc4444', textColor:'#fff', program:'HOT CHOICE — ORDER NOW', type:'shopping', audio:'6.80', stereo:true, videos:[{id:'eOP0CmrNT2A',duration:1491,start:600},{id:'Qj2ihfq7y8c',duration:379}] },
            { num:19, freq:4080, pol:'H', name:'C-SPAN 2', color:'#141428', accent:'#6666aa', textColor:'#ddd', program:'U.S. SENATE PROCEEDINGS', type:'educational', audio:'6.20', stereo:false, videos:[{id:'LbPF6ptGLnI',duration:25907,start:5000}] },
    ...
    },
    {
        ...
        transponders: [
            { num:1,  freq:3720, pol:'H', name:null },
            { num:2,  freq:3740, pol:'V', name:'KUSA Denver ABC', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'WORLD NEWS TONIGHT', type:'network', audio:'6.80', stereo:true, tagline:'Denver 5', videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
            ...
            { num:5,  freq:3800, pol:'H', name:null },
            { num:6,  freq:3820, pol:'V', name:'KMGH Denver CBS', color:'#0a0a28', accent:'#4488ff', textColor:'#fff', program:'CBS 7 DENVER', type:'network', audio:'6.80', stereo:true, videos:[{id:'1tfJAJGR_iM',duration:2565,maxDur:150}] },
            { num:7,  freq:3840, pol:'H', name:null },
            ...
            { num:11,  freq:3920, pol:'H', name:null },
            { num:12, freq:3940, pol:'V', name:null },
            { num:13, freq:3960, pol:'H', name:'SportsChannel Chicago', color:'#0a1a0a', accent:'#44cc44', textColor:'#fff', program:'CHICAGO BLACKHAWKS HOCKEY', type:'sports', audio:'6.80', stereo:true, videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
            ...
            { num:24, freq:4180, pol:'V', name:'Sunshine Network', color:'#161608', accent:'#ccaa44', textColor:'#fff', program:'FLORIDA SPORTS TONIGHT', type:'sports', audio:'6.80', stereo:true, tagline:'Florida Regional Sports', videos:[{id:'1HBgJojaOGQ',duration:1932,maxDur:150}] },
        ]
    },
    {
        name: 'Aurora 1', short: 'A1', pos: 139.0,
        transponders: [
            { num:1,  freq:3720, pol:'H', name:'ARCS Alaska', color:'#0a0a1a', accent:'#44aacc', textColor:'#fff', program:'ALASKA RURAL TV', type:'educational', audio:'6.20', stereo:false, videos:[{id:'Z_ITOFglu2o',duration:3482}] },
            { num:2,  freq:3740, pol:'V', name:null },
            { num:3,  freq:3760, pol:'H', name:null },
            { num:4,  freq:3780, pol:'V', name:'ARCS Feed 2', color:'#0a0a1a', accent:'#44aacc', textColor:'#fff', program:'ALASKA PROGRAMMING', type:'educational', audio:'6.20', stereo:false, videos:[{id:'HLdtxE3uQks',duration:3699}] },
            { num:5,  freq:3800, pol:'H', name:null },
            { num:6,  freq:3820, pol:'V', name:null },
